...
<html>
    <head>
        ...
        <style>
			<?php include('whole_history_style.css')?>
		</style>
    </head>
    <body style="background-color: #E1D5DF;">
        ...
        <div id="container">
			...
			<div id="data">
				...
				<table>
					<tr>
						<th style="text-align: center; font: 20px century gothic;">Username</th>
			...
			<?php
				...
				$result= mysqli_query($conn,"SELECT * from user_transaction_history where deduction != 0 order by username");
